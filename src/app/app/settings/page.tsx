...
// Kept as one save so a half-edited card never partially lands.
function ApplicationDetailsCard({ profile, saveProfile, isMobile }) {
  // State initializes from the loaded profile; the caller re-keys this
  // component on profile identity (see the render site) so a late profile load
  // remounts with real values instead of syncing via an effect.
  ...
  return (
    <Card style={{ gridColumn: isMobile ? undefined : "1 / -1" }}>
      ...
      >
        What the Jugaadu extension fills into job application forms. Only what you enter here is
        used — never guessed.
      </p>
      <div
        style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginTop: 14 }}>
        <InkButton disabled={saving || !dirty} onClick={save}>
